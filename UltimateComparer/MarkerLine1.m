...
- (void)mouseUp:(NSEvent *)theEvent {
    ...
    if (theEvent.clickCount == 0) {
        ...
        [nc postNotificationName:@"locDone1" object:self userInfo:@{@"dragLineRaw": [NSNumber numberWithInteger:dragLineRaw],
         @"toLineRaw": [NSNumber numberWithInteger:toLineRaw], @"button": @"left"}];
        
    } else if (theEvent.clickCount == 2) {
        NSLog(@"Click Twice");
        NSNotificationCenter* nc = [NSNotificationCenter defaultCenter];
        [nc postNotificationName:@"locDone1" object:self userInfo:@{@"dragLineRaw": [NSNumber numberWithInteger:0],
